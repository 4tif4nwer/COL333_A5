        ...
        if(curr_player == WHITE){
            ...
            if(b.data.w_pawn_1 != DEAD){
                if(b.data.w_pawn_1 & PAWN){
                    ...
                    value += weights[5];
                    value += (double)(-0.00001 * (circular_distance_7_3(getx(b.data.w_pawn_1),gety(b.data.w_pawn_1),4,5) + circular_distance_7_3(getx(b.data.w_pawn_1),gety(b.data.w_pawn_1),4,6)));
                }
                else if(b.data.w_pawn_1 & ROOK){
            ...
            if(b.data.w_pawn_2 != DEAD){
                if(b.data.w_pawn_2 & PAWN){
                    ...
                    value += weights[11];
                    value += (double)(-0.00001 * (circular_distance_7_3(getx(b.data.w_pawn_2),gety(b.data.w_pawn_2),4,5) + circular_distance_7_3(getx(b.data.w_pawn_2),gety(b.data.w_pawn_2),4,6)));
                }
            ...
            if(b.data.b_pawn_1 != DEAD){
                if(b.data.b_pawn_1 & PAWN){
                    ...
                    value += weights[24];
                    value += (double)(0.00001 * (circular_distance_7_3(getx(b.data.b_pawn_1),gety(b.data.b_pawn_1),2,1) + circular_distance_7_3(getx(b.data.b_pawn_1),gety(b.data.b_pawn_1),2,0)));
                }
                else if(b.data.b_pawn_1 & ROOK){
            ...
            if(b.data.b_pawn_2 != DEAD){
                if(b.data.b_pawn_2 & PAWN){
                    ...
                    value += weights[30];
                    value += (double)(0.00001 * (circular_distance_7_3(getx(b.data.b_pawn_2),gety(b.data.b_pawn_2),2,1) + circular_distance_7_3(getx(b.data.b_pawn_2),gety(b.data.b_pawn_2),2,0)));
                }
                else if(b.data.b_pawn_2 & ROOK){
